...
import { AppRegistry, ScrollView, Image, Text, Button, StyleSheet, KeyboardAvoidingView, SafeAreaView } from 'react-native';

export default class ScrolledViewScreen extends Component {
    onPressButton() {
